...
interface ContentIdeasFiltersProps {
  ...
  onFilterChange: (key: keyof ContentIdeaFilters, value: string) => void;
}

export default function ContentIdeasFilters({ filters, onFilterChange }: ContentIdeasFiltersProps) {
  return (
