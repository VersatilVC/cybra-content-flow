...
export function NotificationItem({ 
  ...
  const getActionButton = () => {
    if (isContentSuggestionNotification(notification)) {
      const isAutoGenerated = notification.title.includes('Content Ideas Ready') || 
                              notification.message.includes('auto-generated content ideas');
      ...
      return (
        ...
        >
          ...
          {isAutoGenerated ? 'View Content Ideas' : 'View Suggestions'}
        </Button>
      );
    }
