...
CREATE INDEX IF NOT EXISTS documents_competitor_embedding_idx 
ON public.documents_competitor USING hnsw (embedding vector_cosine_ops);

CREATE INDEX IF NOT EXISTS documents_industry_embedding_idx 
ON public.documents_industry USING hnsw (embedding vector_cosine_ops);

CREATE INDEX IF NOT EXISTS documents_news_embedding_idx 
